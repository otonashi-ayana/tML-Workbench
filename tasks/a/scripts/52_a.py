...
os.makedirs(f'/static/assets/img/tasks/a',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/a/Precision-Recall for LogisticRegression.png')
plt.close()
...
os.makedirs(f'/static/assets/img/tasks/a',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/a/ROC Curve for LogisticRegression.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'/static/assets/img/tasks/a',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/a/Precision-Recall for KNeighborsClassifier.png')
plt.close()
...
os.makedirs(f'/static/assets/img/tasks/a',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/a/ROC Curve for KNeighborsClassifier.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'/static/assets/img/tasks/a',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/a/Precision-Recall for SVC.png')
plt.close()
...
os.makedirs(f'/static/assets/img/tasks/a',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/a/ROC Curve for SVC.png')
plt.close()
