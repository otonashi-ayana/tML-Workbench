...
os.makedirs(f'/static/assets/img/tasks/cnmm',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/cnmm/Precision-Recall for LogisticRegression.png')
plt.close()
...
os.makedirs(f'/static/assets/img/tasks/cnmm',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/cnmm/ROC Curve for LogisticRegression.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'/static/assets/img/tasks/cnmm',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/cnmm/Precision-Recall for KNeighborsClassifier.png')
plt.close()
...
os.makedirs(f'/static/assets/img/tasks/cnmm',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/cnmm/ROC Curve for KNeighborsClassifier.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'/static/assets/img/tasks/cnmm',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/cnmm/Precision-Recall for SVC.png')
plt.close()
...
os.makedirs(f'/static/assets/img/tasks/cnmm',exist_ok=True)
plt.savefig(f'/static/assets/img/tasks/cnmm/ROC Curve for SVC.png')
plt.close()
