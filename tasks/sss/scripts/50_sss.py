...
algorithms = ['LogisticRegression', 'KNeighborsClassifier', 'SVC', 'DecisionTreeClassifier']
...
plt.ylabel('Precision')
os.makedirs(f'../outputs',exist_ok=True)
plt.savefig(f'../outputs/Precision-Recall for SVC.png')
plt.close()
...
os.makedirs(f'../outputs',exist_ok=True)
plt.savefig(f'../outputs/ROC Curve for SVC.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'../outputs',exist_ok=True)
plt.savefig(f'../outputs/Precision-Recall for DecisionTreeClassifier.png')
plt.close()
...
os.makedirs(f'../outputs',exist_ok=True)
plt.savefig(f'../outputs/ROC Curve for DecisionTreeClassifier.png')
plt.close()
