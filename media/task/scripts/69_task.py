...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/task/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/task/outputs/Precision-Recall for LogisticRegression.png')
plt.close()
...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/task/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/task/outputs/ROC Curve for LogisticRegression.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/task/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/task/outputs/Precision-Recall for KNeighborsClassifier.png')
plt.close()
...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/task/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/task/outputs/ROC Curve for KNeighborsClassifier.png')
plt.close()
