...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-tML-Workbench\media/task_test/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-tML-Workbench\media/task_test/outputs/Precision-Recall for LogisticRegression.png')
plt.close()
...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-tML-Workbench\media/task_test/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-tML-Workbench\media/task_test/outputs/ROC Curve for LogisticRegression.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-tML-Workbench\media/task_test/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-tML-Workbench\media/task_test/outputs/Precision-Recall for KNeighborsClassifier.png')
plt.close()
...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-tML-Workbench\media/task_test/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-tML-Workbench\media/task_test/outputs/ROC Curve for KNeighborsClassifier.png')
plt.close()
