...
# 加载数据集
try:
    df = pd.read_csv('D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media\databases\heart.csv')
except:
...
algorithms = ['LogisticRegression', 'KNeighborsClassifier', 'SVC']
...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs/Precision-Recall for LogisticRegression.png')
plt.close()
...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs/ROC Curve for LogisticRegression.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs/Precision-Recall for KNeighborsClassifier.png')
plt.close()
...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs/ROC Curve for KNeighborsClassifier.png')
plt.close()
...
plt.ylabel('Precision')
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs/Precision-Recall for SVC.png')
plt.close()
...
os.makedirs(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs',exist_ok=True)
plt.savefig(f'D:\Code\Project\PycharmWorkspaces\PycharmMisc\django-volt-dashboard-master\media/tasks/outputs/ROC Curve for SVC.png')
plt.close()
